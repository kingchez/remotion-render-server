...
export const NewsLowerThird = ({ backgroundImageUrl, headline, subtext, durationInFrames, font = "ui"}) => {
      ...
      <AbsoluteFill style={{ justifyContent: "flex-end" }}>
        <div style={{ transform: `translateY(${offset}px)` }}>
          <div style={{
            ...
            padding: "10px 28px", fontFamily: resolveFont(font), display: "inline-block",
          }}>
            BREAKING
          </div>
          <div style={{
            background: "rgba(0,0,0,0.85)", color: "white", fontSize: 46, fontWeight: 700,
            padding: "20px 28px", fontFamily: resolveFont(font),
          }}>
            {headline}
          </div>
          {subtext ? (
            <div style={{
              ...
              padding: "10px 28px", fontFamily: resolveFont(font),
            }}>
              {subtext}
            </div>
          ) : null}
