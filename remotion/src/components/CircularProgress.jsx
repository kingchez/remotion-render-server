...
export const CircularProgress = ({ label, value, maxValue = 100, unit = "%", durationInFrames, color = "#2E86FF" }) => {
  ...
  return (
    <div style={{
      ...
      alignItems: "center", justifyContent: "center", backgroundColor: "#0F1115", fontFamily: "Arial, sans-serif",
    }}>
